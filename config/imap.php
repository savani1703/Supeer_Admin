    ...
    */
    'accounts' => [
        ...
        'sm_trading_old' => [
            ...
            'encryption' => 'ssl',
            'validate_cert' => true,
            'username' => 'sameerdewan191989@gmail.com',
            'password' => 'sjpwpnlqcbchpinc',
        ],
        'sm_trading' => [
            'host' => 'imap.gmail.com',
            'port' => 993,
            'encryption' => 'ssl',
            'validate_cert' => true,
            'username' => 'smtradingc88@gmail.com',
            'password' => 'mhqsjvcimbkmxyhj',
        ],
        'webexa' => [
            'host' => 'imap.gmail.com',
            'port' => 993,
            'encryption' => 'ssl',
            'validate_cert' => true,
            'username' => 'webaxonli@gmail.com',
            'password' => 'wflhwivfpnosurpg',
        ],
        'beet' => [
            'host' => 'imap.gmail.com',
            'port' => 993,
            'encryption' => 'ssl',
            'validate_cert' => true,
            'username' => 'beetsent@gmail.com',
            'password' => 'izknqklsgsczpqmm',
        ],
        'lohiya' => [
            'host' => 'imap.gmail.com',
            'port' => 993,
            'encryption' => 'ssl',
            'validate_cert' => true,
            'username' => 'lohiyaenterp72@gmail.com',
            'password' => 'ogqkzaprkbiyvzsw',
        ],
        'mittionse' => [
            'host' => 'imap.gmail.com',
            'port' => 993,
            'encryption' => 'ssl',
            'validate_cert' => true,
            'username' => 'mittionse@gmail.com',
            'password' => 'rvpbazsllnmcydsz',
        ],
        'scanex' => [
            'host' => 'imap.gmail.com',
            'port' => 993,
            'encryption' => 'ssl',
            'validate_cert' => true,
            'username' => ' scanextechnop@gmail.com',
            'password' => 'vxswuxoxlrwprjzl',
        ],
        'osum' => [
            'host' => 'imap.gmail.com',
            'port' => 993,
            'encryption' => 'ssl',
            'validate_cert' => true,
            'username' => 'edutechosum@gmail.com',
            'password' => 'wdqhehrxfhvxxiec',
        ],
        'imprexix' => [
            'host' => 'imap.gmail.com',
            'port' => 993,
            'encryption' => 'ssl',
            'validate_cert' => true,
            'username' => 'imprexixunify@gmail.com',
            'password' => 'rqjsutzqmbxobxnc',
        ],
        'mechmobile' => [
            'host' => 'imap.gmail.com',
            'port' => 993,
            'encryption' => 'ssl',
            'validate_cert' => true,
            'username' => 'smartmechmobile@gmail.com',
            'password' => 'nxwbahrnjilxgvvi',
        ],
        'forgshy' => [
            'host' => 'imap.gmail.com',
            'port' => 993,
            'encryption' => 'ssl',
            'validate_cert' => true,
            'username' => 'forghsytraders@gmail.com',
            'password' => 'lhynzzofqqtuoqrk',
        ],
        'surya' => [
            'host' => 'imap.gmail.com',
            'port' => 993,
            'encryption' => 'ssl',
            'validate_cert' => true,
            'username' => 'suryaentp21@gmail.com',
            'password' => 'kkcmxcvvkubhfpry',
        ],
        /*
