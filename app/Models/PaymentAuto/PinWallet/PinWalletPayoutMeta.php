...
namespace App\Models\PaymentAuto\PinWallet;
...
class PinWalletPayoutMeta extends Model
{
    protected $connection = 'payment_auto';
    protected $table = 'tbl_pinwallet_payout_meta';
    ...
    private $defaultAccountId = "PN000";
    private $defaultAccountIdPrefix = "PN";
    ...
    public function addMeta($formData, $accountId) {
        try {
            ...
            $this->merchant_id = PgName::PINWALLET.$accountId;
