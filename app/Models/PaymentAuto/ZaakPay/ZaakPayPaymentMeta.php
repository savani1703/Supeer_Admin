...
namespace App\Models\PaymentAuto\ZaakPay;
...
class ZaakPayPaymentMeta extends Model
{
    use Encryptable;

    protected $connection = 'payment_auto';
    protected $table = 'tbl_zaakpay_payment_meta';
    ...
    public function addMeta($formData, $accountId) {
        try {
            ...
            $this->secret_key = $formData['secret_key'];
