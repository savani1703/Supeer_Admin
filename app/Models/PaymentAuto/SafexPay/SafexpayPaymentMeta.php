...
namespace App\Models\PaymentAuto\SafexPay;
...
class SafexpayPaymentMeta extends Model
{
    use Encryptable;

    protected $connection = 'payment_auto';
    protected $table = 'tbl_safexpay_payment_meta';
    ...
    public function addMeta($formData, $accountId) {
        try {
            ...
            $this->merchant_key = $formData['merchant_key'];
