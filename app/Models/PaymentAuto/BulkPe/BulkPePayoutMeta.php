...
namespace App\Models\PaymentAuto\BulkPe;
...
class BulkPePayoutMeta extends Model
{
    use Encryptable;

    protected $connection = 'payment_auto';
    protected $table = 'tbl_bulkpe_payout_meta';
    ...
    private $defaultAccountId = "BK000";
    private $defaultAccountIdPrefix = "BK";
    ...
    public function addMeta($formData, $accountId) {
        try {
            ...
            $this->merchant_id = PgName::BULKPE.$accountId;
            $this->auth_token = $formData['auth_token'];
    ...
    public function validateFormData($formData, $accountId) {
        ...
        if($this->where("account_id", $accountId)->exists()) {
