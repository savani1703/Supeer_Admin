...
namespace App\Models\PaymentAuto\SabPaisa;
...
class SabPaisaPaymentMeta extends Model
{
    use Encryptable;

    protected $connection = 'payment_auto';
    protected $table = 'tbl_sabpaisa_payment_meta';
    ...
    public function addMeta($formData, $accountId) {
        try {
            ...
            $this->merchant_id = PgName::SABPAISA."_".strtoupper($formData['label']);
            $this->username = $formData['username'];
            $this->password = $formData['password'];
            $this->client_code = $formData['client_code'];
            $this->auth_key = $formData['auth_key'];
            $this->auth_iv = $formData['auth_iv'];
    ...
    public function validateFormData($formData, $accountId) {
        ...
        if($this->where("account_id", $accountId)->where("client_code", $formData['client_code'])->where("is_seamless",  $formData['is_seamless'])->exists()) {
