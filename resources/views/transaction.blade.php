                ...
                <form action="javascript:void(0)" id="txnFilerForm">
                    <div class="row mt-4">
                            ...
                            <div class="form-group">
                                <div class="d-flex ">
                                    <select name="txtFilterKey" id="txtFilterData" class="form-control border-right-0 bg-primary text-white">
                                        ...
                                        <option value="merchant_order_id">Merchant Order Id</option>
                                        <option value="pg_order_id">PG Order Id</option>
                        ...
                        <div class="col-auto">
                            ...
                            <div class="form-group">
                                <select name="pg_name" id="pgList" class="form-control">
                                    <option value="All" selected>All</option>
                        ...
                        <div class="col-auto" id="transactionPg">
...
@section('customJs')
    <script src="{{URL::asset('custom/js/component/transaction.js?v=60')}}"></script>
@endsection
