...
@section('content')
    <div class="card">
        <div class="row">
            ...
            <div class="col-md-12" id="lateSucessMain">
                <div class="card">
                    <div class="card card-outline-info mb-0">
                        <div class="p-3">
                            <h6 class="font-weight-bold">Late Success </h6>
                        </div>
                        <div class="card-body shadow-sm">
                            <form action="javascript:void(0)" id="lateSuccessForm">
                                <div class="row mt-4">
                                    <div class="col-auto">
                                        <div class="form-group">
                                            <div class="d-flex ">
                                                <select name="FilterKey"  class="form-control border-right-0 ">
                                                    <option value="search_value">Search Data</option>
                                                </select>
                                    ...
                                    <div class="col-auto">
                                        ...
                                        <button class="btn btn-danger" type="button"  onclick="resetLateSuccess()">Clear</button>
                                    </div><!-- Col -->
                                </div>
                            </form>
                        </div>
...
@section('customJs')
    <script src="{{URL::asset('custom/js/component/late-success.js?v=1')}}"></script>
@endsection
