                ...
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title d-flex justify-content-between">
                            Mail Reader
                            <button class="btn btn-primary" onclick="addMailReader()">Add Mail Reader</button>
                        </h6>


                        <div class="card-body shadow-sm">
                            <form action="javascript:void(0)" id="MaileReaderFilterForm">
                                <div class="row">
                                    <div class="col-auto">
                                        ...
                                        <div class="form-group">
                                            <div class="d-flex ">
                                                <select name="search_key"  class="form-control border-right-0 ">
                                                    <option value="av_bank_id">Bank ID</option>
                                                    <option value="username">Username</option>
                                                    <option value="mail_sender">Mail Sender</option>
                                    ...
                                    <div class="col-auto mt-4">
                                        ...
                                        <button class="btn btn-danger border-0" type="reset"  onclick="resetMailReaderFilter()">Clear</button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
@section('customJs')
    ...
    <script src="{{URL::asset('custom/js/component/developer/dashboard/mail-reader.js?v=1')}}"></script>
@endsection
